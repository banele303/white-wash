...
import KitchenImage from "../../public/white-wash/wall-painting.jpeg";
  ...
  return (
    ...
    <div className="relative h-screen">
      ...
      <div className="relative h-[100vh] md:h-[100vh] w-full">
        <Image src={KitchenImage} alt="bees" className="brightness-50 md:h-[100vh] h-full w-full" />
            ...
            <div className="px-[2rem]  mt-[6rem]">
              ...
              <div className="grid grid-cols-1  md:grid-cols-2 gap-6 pt-[7rem] md:pl-[3rem] md:h-[580px]">
                <div className="md:pl-[3rem]">
                  <h1 className="text-2xl md:text-4xl pt-[8rem] md:pt-[3rem] leading-9 text-slate-100 font-extrabold">
                   Your Full Painting Service Company
                  </h1>
                  <p className="text-xl md:text-2xl py-6   text-slate-200 font-extrabold">
                    Interior and Exterior Painting For Every House 
                  </p>
